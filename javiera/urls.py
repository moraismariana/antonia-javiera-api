...
from javiera.views import ArtigoViewSet, FormularioContatoViewSet, InicioTextoViewSet, InicioImgViewSet, InicioBgViewSet, SobreTextoViewSet, SobreImgViewSet, ComponenteArtigosTextoViewSet, ComponenteContatoTextoViewSet
